const e=`> Paste the code below into your Apps Script \`Code.gs\` (or the script editor of a standalone project). Replace \`SHEET-ID-HERE\` with your spreadsheet ID.
